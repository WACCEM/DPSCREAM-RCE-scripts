...
export casename=test_output_dpxx_RCE
...
# Code tag name
export code_tag=fix-output-manager
...
# End Case specific stuff here
  ...
  required_branch="ksa/fix-output-manager-restart"
...
if [ "$edit_output" = true ]; then
  ...
  # Note that you can have as many output streams (yaml files) as you want!
    ...
    yamlfile1=scream_new_output_avg_5min.yaml
    yamlfile2=scream_new_output_inst_5min.yaml

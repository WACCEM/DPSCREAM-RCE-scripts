...
export casename=test_regrid_cpu_dpxx_RCE_dx1km
...
if [ "$edit_output" = true ]; then
  ...
  # Note that you can have as many output streams (yaml files) as you want!
    #cp ${yamlpath}/scream_horiz_avg_output_5min.yaml .
    #cp ${yamlpath}/scream_output_avg_5min.yaml .
    #cp ${yamlpath}/scream_output_inst_5min.yaml .
    # ln -s ${yamlpath}/scream_horiz_avg_output_5min.yaml
    # ln -s ${yamlpath}/scream_output_avg_5min.yaml
    # ln -s ${yamlpath}/scream_output_inst_5min.yaml
    [ ! -L scream_output_inst_5min_test.yaml ] && ln -s ${yamlpath}/scream_output_inst_5min_test.yaml

    #comment out below from the sceond time to run without cleaning the case setup, otherwise the same option keeps being added
    # ./atmchange output_yaml_files="./scream_horiz_avg_output_5min.yaml"
    # ./atmchange output_yaml_files+="./scream_output_avg_5min.yaml"
    # ./atmchange output_yaml_files+="./scream_output_inst_5min.yaml"
    ./atmchange output_yaml_files="./scream_output_inst_5min_test.yaml"

...
if(SIMULATION_TYPE == 'DP-SCREAM'):
    INPUT_DIR = f'/pscratch/sd/w/wcmca1/DP-SCREAM/{CASE_NAME}/org_ind'
    INPUT_FILE = f'{CASE_NAME}_LW_flux_up_at_model_top_2000-01-01_to_2000-04-30.nc'

INPUT_FILE_PATH = f'{INPUT_DIR}/{INPUT_FILE}'


# Domain information
if('150km' in CASE_NAME):
